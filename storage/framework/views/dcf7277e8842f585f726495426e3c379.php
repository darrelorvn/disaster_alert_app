...
<div class="p-8 bg-[#F8FAFC] min-h-screen">
    ...
    <div class="bg-orange-500 border border-slate-200 rounded-xl shadow-sm p-6 mb-8 relative overflow-hidden">
        <div class="relative z-10">
            ...
            <p class="text-white/90 leading-relaxed mb-5"><?php echo e($recommendation->recommendation_text); ?></p>
            <form method="POST" action="<?php echo e(route('user.ai-recommendation.refresh')); ?>" class="flex items-center gap-4">
                <?php echo csrf_field(); ?>
                ...
                <span class="text-sm text-white/80 font-medium">
                    Diperbarui <?php echo e($recommendation->generated_at->diffForHumans()); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-6 flex flex-col justify-between shadow-sm hover:shadow-md transition-all group">
                    <div>
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-[11px] font-bold text-slate-400 uppercase tracking-wider">
                                ...
                                <?php echo e($item->created_at ? $item->created_at->diffForHumans() : 'Baru saja'); ?>
                    ...
                    <div class="mt-5 pt-4 border-t border-slate-50 text-right">
                        <a href="<?php echo e($item->url); ?>" target="_blank" rel="noopener noreferrer" class="text-[12px] font-black !text-orange-600 uppercase hover:!text-orange-700 transition-colors inline-flex items-center gap-1">
