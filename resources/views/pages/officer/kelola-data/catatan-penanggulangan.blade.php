...
<div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 py-5 px-6">
    ...
    <span class="text-slate-500 text-[11px] font-extrabold whitespace-nowrap">Showing 31 results</span>
</div>
    ...
    <table class="w-full min-w-[960px] border-collapse">
        <thead class="bg-slate-100">
            <tr>
                ...
                <th class="py-[17px] px-5 text-slate-700 text-[11px] font-black tracking-[0.08em] text-left uppercase whitespace-nowrap">Dicatat Oleh</th>
                <th class="py-[17px] px-5 text-slate-700 text-[11px] font-black tracking-[0.08em] text-left uppercase whitespace-nowrap">Status Verifikasi</th>
        ...
        <tbody>
            <tr class="hover:bg-slate-50 transition-colors">
                <td class="py-[18px] px-5 border-t border-slate-100 text-slate-900 text-[13px] font-black align-middle max-w-[260px]">Distribusi logistik & evakuasi warga RW 05 ke Posko Cawang</td>
                <td class="py-[18px] px-5 border-t border-slate-100 text-slate-600 text-[13px] align-middle">Banjir Bandang<br>Cawang</td>
                <td class="py-[18px] px-5 border-t border-slate-100 text-slate-600 text-[13px] align-middle">Kol. Hendra W.</td>
                <td class="py-[18px] px-5 border-t border-slate-100 text-[13px] align-middle">
                    <span class="inline-flex items-center justify-center rounded-full py-1 px-2.5 text-[10px] font-black uppercase bg-emerald-100 text-emerald-600">Terverifikasi</span>
                </td>
                <td class="py-[18px] px-5 border-t border-slate-100 text-[13px] align-middle">
