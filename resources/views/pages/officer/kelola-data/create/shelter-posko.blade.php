...
<div class="min-h-screen bg-slate-50 p-6 md:p-8 font-sans text-slate-800">
    ...
    <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <form action="{{ route('officer.kelola-data.shelter.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Posko Pengungsian Balai Desa" required
                        class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-800 placeholder:text-slate-400 outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-500/10 @error('name') border-red-400 bg-red-50 @enderror">
                ...
                <div>
                    ...
                    <div class="relative">
                        <select id="status" name="status" required class="w-full appearance-none rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-800 outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-500/10 @error('status') border-red-400 bg-red-50 @enderror">
                            <option value="active" {{ old('status') == 'active' ? 'selected' : '' }}>Tersedia / Aktif</option>
                ...
                <div>
                    ...
                    <input type="number" id="capacity" name="capacity" value="{{ old('capacity') }}" placeholder="Contoh: 150" min="0"
                        class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-800 placeholder:text-slate-400 outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-500/10 @error('capacity') border-red-400 bg-red-50 @enderror">
                ...
                <div>
                    ...
                    <input type="text" id="contact" name="contact" value="{{ old('contact') }}" placeholder="Contoh: 081234567890"
                        class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-800 placeholder:text-slate-400 outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-500/10 @error('contact') border-red-400 bg-red-50 @enderror">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="area" name="area" value="{{ old('area') }}" placeholder="Contoh: Kecamatan Cawang, Jakarta Timur"
                        class="w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-800 placeholder:text-slate-400 outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-500/10 @error('area') border-red-400 bg-red-50 @enderror">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="address" name="address" rows="3" placeholder="Masukkan alamat lengkap..."
                        class="w-full resize-none rounded-lg border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm font-semibold text-slate-800 placeholder:text-slate-400 outline-none transition focus:border-orange-400 focus:bg-white focus:ring-2 focus:ring-orange-500/10 @error('address') border-red-400 bg-red-50 @enderror">{{ old('address') }}</textarea>
